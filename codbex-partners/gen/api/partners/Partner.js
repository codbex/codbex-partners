...
const dao = require("codbex-partners/gen/dao/partners/Partner");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-partners/gen/api/Partner.js/" + entity.Id);
