...
const dao = require("codbex-partners/gen/dao/partners/Supplier");
...
rs.service()
	...
	.resource("")
		.post(function(ctx, request, response) {
			...
			response.setHeader("Content-Location", "/services/js/codbex-partners/gen/api/Supplier.js/" + entity.Id);
