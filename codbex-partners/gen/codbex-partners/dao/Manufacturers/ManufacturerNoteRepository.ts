...
export interface ManufacturerNoteEntityEvent {
...
export interface ManufacturerNoteUpdateEntityEvent extends ManufacturerNoteEntityEvent {
...
export class ManufacturerNoteRepository {
    ...
    constructor(dataSource = "DefaultDB") {
        this.dao = daoApi.create(ManufacturerNoteRepository.DEFINITION, undefined, dataSource);
    }
    ...
    public findById(id: number, options: ManufacturerNoteEntityOptions = {}): ManufacturerNoteEntity | undefined {
