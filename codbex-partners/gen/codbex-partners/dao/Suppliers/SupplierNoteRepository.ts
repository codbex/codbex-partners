...
export class SupplierNoteRepository {
    ...
    public findById(id: number, options: SupplierNoteEntityOptions = {}): SupplierNoteEntity | undefined {
    ...
    public count(options?: SupplierNoteEntityOptions): number {
    ...
    private async triggerEvent(data: SupplierNoteEntityEvent | SupplierNoteUpdateEntityEvent) {
