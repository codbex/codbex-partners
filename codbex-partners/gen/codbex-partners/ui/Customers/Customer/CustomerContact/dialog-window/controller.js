	...
	.controller('PageController', ($scope, $http, ViewParameters, EntityService) => {
		...
		$scope.create = () => {
			...
			EntityService.create(entity).then((response) => {
				...
				Notifications.show({
					...
					description: 'CustomerContact successfully created',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				...
				Dialogs.showAlert({
					title: 'CustomerContact',
					message: `Unable to create CustomerContact: '${message}'`,
		...
		$scope.update = () => {
			...
			EntityService.update(id, entity).then((response) => {
				...
				Notifications.show({
					title: 'CustomerContact',
					description: 'CustomerContact successfully updated',
					type: 'positive'
				});
				$scope.cancel();
			}, (error) => {
				...
				Dialogs.showAlert({
					title: 'CustomerContact',
					message: `Unable to update CustomerContact: '${message}'`,
					type: AlertTypes.Error
				});
				console.error('EntityService:', error);
			});
