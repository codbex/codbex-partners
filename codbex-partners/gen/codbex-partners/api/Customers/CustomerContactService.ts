...
import { CustomerContactRepository, CustomerContactEntityOptions } from "../../dao/Customers/CustomerContactRepository";
...
class CustomerContactService {
    ...
    private readonly repository = new CustomerContactRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            this.checkPermissions("read");
            const options: CustomerContactEntityOptions = {
