...
class SupplierNoteService {
    ...
    private readonly repository = new SupplierNoteRepository();
    ...
    public create(entity: any) {
        try {
            ...
            response.setHeader("Content-Location", "/services/ts/codbex-partners/gen/codbex-partners/api/Suppliers/SupplierNoteService.ts/" + entity.Id);
