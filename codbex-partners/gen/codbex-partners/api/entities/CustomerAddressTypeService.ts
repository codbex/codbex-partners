...
class CustomerAddressTypeService {
    ...
    private readonly repository = new CustomerAddressTypeRepository();

    @Get("/")
    public getAll(_: any, ctx: any) {
        try {
            const options: CustomerAddressTypeEntityOptions = {
    ...
    public getById(_: any, ctx: any) {
        try {
            ...
            if (entity) {
                ...
                HttpUtils.sendResponseNotFound("CustomerAddressType not found");
            }
        } catch (error: any) {
            this.handleError(error);
        }
