...
export class CountryRepository {
    ...
    private async triggerEvent(data: CountryEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-partners/entities/Country", ["trigger"]);
        ...
        producer.queue("codbex-partners/entities/Country").send(JSON.stringify(data));
    }
}