...
export class CityRepository {
    ...
    private async triggerEvent(data: CityEntityEvent) {
        const triggerExtensions = await extensions.loadExtensionModules("codbex-partners/Cities/City", ["trigger"]);
        ...
        producer.topic("codbex-partners/Cities/City").send(JSON.stringify(data));
    }
}